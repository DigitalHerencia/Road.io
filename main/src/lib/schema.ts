...
export const safetyProgramStatusEnum = pgEnum('safety_program_status', ['ASSIGNED', 'COMPLETED']);
...
export type SafetyProgram = typeof safetyPrograms.$inferSelect;
export type NewSafetyProgram = typeof safetyPrograms.$inferInsert;
export type DriverSafetyProgram = typeof driverSafetyPrograms.$inferSelect;
export type NewDriverSafetyProgram = typeof driverSafetyPrograms.$inferInsert;
